<div navbar-fixed>
<nav>
    <div class="nav-wrapper" <?php echo 'style="background-color: '.$second_color.'"' ?>>
      <a href="/admin/" class="brand-logo"><?php echo $app_name ?><span style="font-size:10px;" class="hide-on-med-and-down">Admin your way</span></a>
